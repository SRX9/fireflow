...
import { Layout, Menu, Icon, Divider, List, Avatar  , Input, Form, Button, Modal, message } from 'antd';
import './main.css';
                ...
                <Layout style={{ height: "100vh" }} className="msg">
                    <Header style={{ background: '#fff', padding: 0,height:"6.8vh" }}>
                        <div className="f2 pl3 dib">
                            ...
                            <span className="pl1 f3 fw6 dib black pr2">{this.state.roomName} </span>
                        </div>
                        <div className="fr f4 fw4 black-50  pr4">
                            Admin<span className="f4 dib pl1  gray  fw6">{this.state.admin}</span>
                        </div>
                    </Header>
                    <Row>
                    <Col xs={10}>
